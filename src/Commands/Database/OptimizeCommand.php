...
class OptimizeCommand extends AbstractMaintenanceCommand
{
    protected function configure()
    {
        $this->configureMaintenanceCommand('db:optimize', 'Optimize OpenCart database tables');
    }
    ...
    protected function handle()
    {
        ...
        foreach ($tables as $table) {
            ...
            $query = $db->query("OPTIMIZE TABLE `{$escapedTable}`");
        ...
        $this->renderMaintenanceResults('Database Table Optimization', $results);
