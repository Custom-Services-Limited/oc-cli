...
class VersionCommandCompleteTest extends TestCase
{
    ...
    {
        return Application::resolveVersion(true);
    }
    ...
    public function testJsonFormatWithOpenCartDetected()
    {
        ...
        try {
            ...
            $this->assertEquals($this->currentVersion(), $json['oc-cli']);
    ...
    public function testYamlFormatWithOpenCartDetected()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('oc-cli: ' . $this->currentVersion(), $output);
